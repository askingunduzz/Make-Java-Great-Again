...
public class TopClass implements ActionListener, KeyListener {
    ...
    private static final int BIRD_WIDTH = 100, BIRD_HEIGHT = 50;
    ...
    private void buildFrame() {
     //   Image icon = Toolkit.getDefaultToolkit().getImage(this.getClass().getResource("C:\\Users\\askin\\OneDrive\\Masa¸st¸\\asli oyun\\flappy.png"));
     //   Image icon = new ImageIcon(this.getClass().getResource("C:\\Users\\askin\\OneDrive\\Masa¸st¸\\asli oyun\\flappy.png")).getImage();
        Image icon = null;
        try {
            icon = ImageIO.read(getClass().getResourceAsStream("/oyun1/plane.png"));
            //flappyBird = ImageIO.read(getClass().getResourceAsStream("/oyun1/flappyjpg"));
    ...
    private void collisionDetection(BottomPipe bp1, BottomPipe bp2, TopPipe tp1, TopPipe tp2, Bird bird) {
        ...
        if(bird.getY() + BIRD_HEIGHT > SCREEN_HEIGHT*7/8) { //ground detection
            ...
            retryButton.addActionListener(new ActionListener() {
                public void actionPerformed(ActionEvent e) {
                    // Your code to start the game again goes here
                }
            });
    ...
    private void collisionHelper(Rectangle r1, Rectangle r2, BufferedImage b1, BufferedImage b2) {
        if(r1.intersects(r2)) {
            ...
            int firstI = (int) (r.getMinX() - r1.getMinX()); //firstI is the first x-pixel to
            // iterate from
